document.addEventListener("DOMContentLoaded", function(event) {
    ...
    // Flip Card & Assigning a Click Event
    ...
    // Cecking FOR MATCHED FLIPPED CARDS for Matching Flipped Cards
    ...
    // TO MATCH funciton when cards fail to match
    function fail() {
    ...
    // funciton for  MOdel Pop up {congrats popup}
    function popupModal() {
    ...
    reset.addEventListener("click", memoryGameBoard);
